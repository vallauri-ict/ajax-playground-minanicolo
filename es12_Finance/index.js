...
function searchFinance(Value,table) {
    if(Value.length>=2)
    {
        Value.toUpperCase();
        let url = "https://www.alphavantage.co/query?function=GLOBAL_QUOTE&symbol=" + Value + "&apikey="+apiKey;
        $.getJSON(url,
            function (data) {
